<%-- 
    Document   : consulta
    Created on : 30/06/2021, 08:19:53 AM
    Author     : HOME
--%>
...
<html>
    <head>
        ...
        <title>CONSULTA Pacientes Hospital Gutierrez</title>
                <!--Icono-->
...
<!-----------------------------/BOOTSTRAP----------------------------->
    ...
    <body>
    <marquee><h1>CONSULTA DE Pacientes Hospital Gutierrez</h1></marquee>
    <center><h1>Sistema de control Hospital Gutierrez</h1></center>
    <hr>
    ...
    String consultaAlumnos="SELECT * FROM tpaciente";//consulta que llama los campos y registros de tabla
     ...
     <div class="container">
           <div class="jumbotron">
               <center><h2>Consulta de pacientes Hospital Gutierrez</h2></center>
               <img src="imagenes/consulta.jpg" class="img img-responsive" alt="ini"/>
               <hr>
               <div class="thumbnail">
                   <center>
                       <!--Tabla bootstrap -->
